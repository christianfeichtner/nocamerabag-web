---
title: 'My Apple Smart Battery Case Review for iPhone Photographers'
date: '2020-05-11T17:05:07'
page_id: "oX4TuYkCRl"
slug: review-apple-smart-battery-case
draft: false
...
- Review
- Power Banks
affiliate_id: "affiliates://smart-battery-case-for-the"
affiliate_label: "Buy on Amazon"
description: Ready why the Apple Smart Battery Case is a great case for iPhone users
  and especally iPhone Photographers.
cover:
  image: /images/reviews/general/review-apple-smart-battery-case.webp
  alt: 'Review: Apple Smart Battery Case'
---
...
1. It's a protective case that's a bit thicker than standard cases. I just wanted that extra layer of protection
2. The Apple Battery Case is smart and unobtrusive. I don't have to turn it on; it just keeps my iPhone charged
3. I can charge the battery case and the iPhone wirelessly and still can use a wall charger and cable if I need to
4. The photo button, which is excellent for quick snapshots using the stock iPhone camera app.
5. I didn't want to carry a power bank anymore.
...
If you've been reading my blog for a while, you know I'm a fan of Anker Power Banks. So far, I used the [Anker 10.000 mAh Slim Power Bank](/blog/review-anker-powercore-ii-slim-10000-mah-power-bank) as my Everyday Carry charger and the [Anker PowerCore II 26.800 mAh](/blog/review-anker-power-core-26800-mah-high-capacity-powerbank) for traveling.
...
The Apple Smart Battery Case is available for different iPhone models in different colors from Amazon, e.g., the [Smart Battery Case for the iPhone 11 Pro](aff:smart-battery-case-for-the) or you can visit the [Apple Storefront on Amazon](aff:apple-storefront-amazon) to see all of them.

As of May 2021, Apple did not yet announce such a case. So I bought a MageSafe compatible power bank from Anker. Check out my my [Anker Powercore Magnetic 5K review](/blog/review-anker-powercore-magnetic-5k).
