---
title: My Moment iPhone Case Review with Wrist-Strap Mount
date: '2023-11-14T19:27:00'
page_id: "VIROX7NMeK"
slug: review-moment-photo-case
draft: false
author: Chris Feichtner
categories:
- iPhone Photography
featured: false
secondary_title: "Moment iPhone Case"
secondary_description: "Durable protective case with a dedicated wrist-strap mount and lens attachment interface."
affiliate_id: "affiliates://moment-photo-case"
affiliate_label: "Check price on ShopMoment"
tags:
- Photo Accessories
- Review
- Cases
description: 'I’ve been using the Moment iPhone case for each new iPhone for almost
  a decade. It protected my iPhone during dozens of trips all around the world: What
  I like and what I don’t like.'
cover:
  image: /images/reviews/general/moment-iphone-14-case.webp
  alt: The Moment iPhone case with wrist-strap mount. A review
---
I bought and used the moment phone case for each new iPhone for almost a decade. I still remember buying the first Moment photo case on Kickstarter in 2015.

The moment phone case is a great and robust case and I bought it mainly to be able to attach moment lenses and because it allowed me to add a wrist strap.

{{< toc >}}

## Why I bought the Moment iPhone case
...
I originally bought the Moment photo case to attach the Moment lenses to my iPhone. But since the release of the iPhone 12, I haven't used Moment lenses. But that changed in 2023. I ordered the 2023 edition of the Moment wide lens together with the case and have been using it to shoot wide angle photos with the 48 megapixel lens of the iPhone 15.

The second reason I bought the Moment case is because you can attach a wrist strap - an essential feature for me.

The iPhone case served me well for almost a decade. But I didn’t order one for the iPhone 16, because I started to use a cage solution for my iPhone 16.

## Features of the Moment iPhone Case
...
You must purchase the lens mount separately. So don't forget to add it to the cart at the moment Online Store.
...
Moment cases for iPhone 14 and later are all MagSafe compatible and support wireless charging. I use the [Apple MagSafe Charger](aff:apple-magsafe-charger) to charge my iPhone at home and the [Anker 521 magnetic battery](/blog/review-anker-powercore-magnetic-5k) for charging it on the go. Both work great with the new Moment Case for my iPhone 15 and snap into place magnetically. Moment also claims that the magnet of the new iPhone 15 case is 15% stronger. I didn't test that for two reasons: first, the magnet was already pretty strong in previous editions of the case, and, secondly, I don't know how I should test it.

Of course, the Moment iPhone 15 cases also work with the [Moment MagSafe Tripod Mount](affiliates://moment-magsafe-tripod-mount) that I use for attaching it to a tripod.

### iPhone Action Button Compatibility
...
Speaking of buttons, one thing you must be aware of is that the other buttons of the Moment case for volume and locking it are too smooth for my personal taste. I'd prefer if I had to press the buttons more firmly.

## Other iPhone cases with wrist strap support

During the last years more brands launched phone cases with wrist strap support. For example Bellroy offers the iPhone Venture case. You can get it from Amazon and I’ve linked them as a courtesy: the [Bellroy Venture Phone case for iPhone 16 Pro](affiliates://bellroy-venture-case-iphone-16-pro) and [Bellroy Venture Phone case for the iPhone 16 Pro Max](affiliates://bellroy-venture-case-iphone-16-pro-max).

Alternatively I’ve found a solution for my companion for our Ireland road trip that allows you to [attach a wrist strap to almost any iPhone case](/blog/attach-wrist-strap-any-iphone-case).

## Summary: Would I repurchase the Moment case for iPhone?

Let's forget about the lenses for a moment (pun intended). I've been buying Moment cases for my iPhones for almost a decade. It protected my iPhone when I accidentally dropped it, and I could attach a wrist strap to the case. Those are two essential features for me as an iPhone photographer.

If I wouldn’t have turned to a cage solution, I’d still buy the moment case because of the reasons mentioned above.

To get yourself a Moment case, head over to the Moment to buy a {{< affiliate "affiliates://moment-photo-case" "Moment Case for any iPhone Model" >}}.
