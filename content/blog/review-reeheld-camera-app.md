---
title: My Reeheld App Review for Handheld iPhone Long Exposures
date: '2023-08-13T15:46:13'
page_id: "omiOurMOyp"
slug: review-reeheld-camera-app
draft: false
author: Chris Feichtner
categories:
- iPhone Photography
featured: true
secondary_title: "Reeheld Camera App"
secondary_description: "Take handheld long exposure photos up to 30 seconds with iPhone without a tripod using smart AI stabilization."
affiliate_id: "affiliates://reeheld-long-exposure-camera-app"
...
description: Reeheld is a camera app for taking long exposure photos with iPhone -
  without a tripod. Read why I love and use it regularly. Updated for iPhone 16.
cover:
  image: /images/reviews/general/reeheld-review-teaser.webp
  alt: Reeheld camera app for long exposure photography. A review
---
...
### Supports the iPhone 16 camera button

Reeheld camera app supports the iPhone 16 camera button. But unfortunately only for taking photos. Unlike other camera apps, Reeheld does not allow you (yet?) to change the lens by lightly pressing and swiping over the new camera button.

What I'd like to see is a way to adjust the exposure time by sliding over the camera button instead of changing the lens. I'd find that much more useful.
...
![](/images/reviews/general/reeheld-camera-app-options.webp)

Here you can enable two important options: a smart indicator and GPS.

![](/images/reviews/general/smart-indicator-gps.webp)
...
![](/images/reviews/general/reeheld-smart-indicator.webp)
...
![](/images/reviews/general/reeheld-lens-selector.webp)
...
![](/images/reviews/general/long-exposure-ferris-wheel-reeheld-app.webp)
...
At the time of writing, [Reeheld camera app is available as a one-time purchase from the App Store](aff:reeheld-long-exposure-camera-app). You can download and try it for free and if you decide to keep it, it can be yours for a one-time in-app purchase.
