---
title: What is the Framing and how to use it in Photography
date: '2019-11-18T16:25:00'
page_id: "Cz5StdiKVD"
slug: what-is-framing-photography
draft: false
...
- Framing
description: Framing is a great photo technique to enhance your photos. In this blog
  post you’ll find some framing ideas for your travel photography.
cover:
  image: /images/tutorials/usa/fountains-bellagio-window.webp
  alt: What is the Framing and how to use it in Photography
---
...
![Example of a full frame (window)](/images/tutorials/usa/aabandoned-grand-piano-grabowsee.webp "Example of a full frame (window).")

![Example of a partial frame (Tree branches)](/images/tutorials/usa/skyscraper-shell-tirana.webp "Example of a partial frame (Tree branches).")
...
![The Empire State Building framed by other buildings](/images/tutorials/usa/empire-state-building-framed.webp "The Empire State Building framed by other buildings.")
...
![Photo of a grand piano framed by a window](/images/tutorials/usa/aabandoned-grand-piano-grabowsee.webp "Photo of a grand piano framed by a window.")
...
![Using branches of a tree to frame a shell of a skyscraper](/images/tutorials/usa/skyscraper-shell-tirana.webp "Using branches of a tree to frame a shell of a skyscraper.")

### Use light and shadows as a frame

I discovered this abandoned dentist’s chair at the abandoned Beelitz Heilstätten in a building that was used as a [film location for A Cure for Wellness](/blog/filming-location-a-cure-for-wellness). The photo is a good example of how to use lights and shadows as a frame.

![A photo of an bandoned dentist's chair framed by light](/images/tutorials/usa/abandoned-dentist-chair-beelitz.webp "A photo of an bandoned dentist's chair framed by light.")
...
![Use framing to convey depth in a photo](/images/tutorials/usa/abandoned-manor-estonia.webp "Use framing to convey depth in a photo.")
...
![Adding context by using the framing technique](/images/tutorials/usa/aabandoned-grand-piano-grabowsee.webp "Adding context by using the framing technique.")
...
![The Fountains of Bellagio framed by a window](/images/tutorials/usa/fountains-bellagio-window.webp "The Fountains of Bellagio framed by a window.")

On the other hand, if you’d use a low contrast and color rich frame, this may convey exactly the opposite: harmony and happiness. To darken the frame and add more contrast, you can use any photo editing app that allows you to use brushes, like [Adobe Lightroom mobile](/blog/review-adobe-lightroom-mobile-premium), which is my favorite photo editing app.
...
![Using branches of a tree as a partial frame to fill negative space](/images/tutorials/usa/skyscraper-shell-tirana.webp "Using branches of a tree as a partial frame to fill negative space.")
