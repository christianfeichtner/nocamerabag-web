---
title: 'My Favorite Blue Hour and Golden Hour Calculators for iPhone'
date: '2017-02-08T20:52:46'
page_id: "TUVq1OJUgS"
slug: review-blue-hour-calculators-iphone
draft: false
...
- Golden Hour
- Blue Hour
description: The blue hour is one of the best periods of the day to take outdoor photos.
  Here are two blue hour calculators I use.
cover:
  image: /images/iphone-photography/general/blue-hour-calculator-sun-surveyor.webp
  alt: 'Review: Blue Hour and Golden Hour Calculators for iPhone'
---
...
ProCamera App is an excellent camera app with tons of awesome features. I've been using it for years. Check out my [ProCamera App Review](/blog/procamera-app-review) if you're curious about it.
...
• Find the location of the sun and the moon using augmented reality.
• Identify photo opportunities of, e.g., full moon, crescent moon, visible milky way.
...
[Sun Surveyor is available from the App Store](aff:sun-surveyor-sun-moon-app). If you're curious about ProCamera, head over to my [ProCamera App review](/blog/procamera-app-review) or [get ProCamera from the App Store](aff:procamera-app).
