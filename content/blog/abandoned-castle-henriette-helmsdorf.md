---
title: Photos from my Urbex Tour at the abandoned Castle Henriette-Helmsdorf
date: '2025-05-15T17:33:45'
page_id: "BcjB6yQjTj"
slug: abandoned-castle-henriette-helmsdorf
draft: false
...
- Germany
- Urbex Tour
description: The abandoned castle Henriette-Helmsdorf served as a home for elderly
  people for several decades. In 1994, it was abandoned. See some photos of this sleeping
  beauty.
...
The castle is located on a private property. Thus, do not try to get into it without permission. Luckily, my favorite lost places tour operator, go2know, offers legal access to the abandoned castle Henriette. To learn more, head to the [castle Henriette tour page](aff:go2know-schloss-henriette) (in German).
...
Urbex tour offerings and site conditions change over time. I don't verify whether tours are still conducted exactly as when I attended. Be sure to check the tour operator’s website at the end of this post for up-to-date information.
{{< /callout >}}
...
{{< timeline
  ...
  open="true"
  t1_year="1801–1805"
  t1_title="Construction of the Classical Manor"
  t1_desc="The grand manor house was built for Louise Ernestine Henriette von Bülow and her husband, giving the castle its enduring name."
  t2_year="1879"
  t2_title="Expansion by the von Krosigk Family"
  t2_desc="The noble von Krosigk family acquired the estate and extensively renovated the residence with ornate neo-Baroque details and parklands."
  t3_year="1945"
  t3_title="Post-War Land Reform & Expropriation"
  t3_desc="Following the end of World War II, the estate was expropriated during Soviet-administered land reforms as the region became part of East Germany."
  t4_year="1950s–1980s"
  t4_title="GDR Municipal Retirement Home"
  t4_desc="The East German government converted the historic mansion into a state-run retirement home (*Feierabendheim*), housing senior citizens for several decades."
  t5_year="1994"
  t5_title="Closure & Heritage Stewardship"
  t5_desc="The nursing home closed permanently, leaving the castle vacant. Today, local preservationists protect the remote structure and facilitate legal access."
>}}
...
So basically, the main subject is double-framed. Framing in photography is one of the techniques I recommend learning. You can find more about this composition technique in my blog post about [framing in photography](/blog/what-is-framing-photography).
...
Last year I bought a rig for my iPhone, and I’m so happy I did. The handle and fill light I’ve attached to the rig makes photographing in a lost place so much easier. I’ve written about this iPhone photo accessory in my [Neewer iPhone photo cage review](/blog/review-neewer-iphone-cage).
