---
title: Photos from my visit to the abandoned Stadtbad in Berlin
date: '2024-06-06T17:27:28'
page_id: "6VJB9yC6o-"
slug: abandoned-stadtbad-lichtenberg
draft: false
...
- Germany
- Urbex Tour
description: The Stadtbad Lichtenberg, also known as Hubertusbad, is a beautiful public
  bathhouse and a lost place in Berlin where I could photograph recently.
affiliate_id: "affiliates://go2know-das-alte-hubertusbad"
cover:
  image: 
  alt: Photos from my visit to the abandoned Stadtbad in Berlin
---
...
The best way to get into the Hubertusbad is by booking an official ticket, like I did. As always, I booked directly from [go2know.de](aff:go2know-das-alte-hubertusbad) (the page is only available in German). During the tour, you’ll have four hours to explore and photograph the abandoned Stadtbad Lichtenberg at your own pace.
...
Urbex tours and site access rules change on a regular basis. I don't monitor whether visits are still hosted in the exact same way as when I was there. Please verify current details on the provider's website at the end of this post.
{{< /callout >}}
...
{{< timeline
  ...
  open="true"
  t1_year="1928"
  t1_title="Opening of the Modern Hubertusbad"
  t1_desc="Designed by architect Rudolf Gleye, the municipal bathhouse opened with dual swimming halls and specialized medical tub baths to improve hygiene in working-class Berlin."
  t2_year="1945"
  t2_title="Post-War Survival & Reconstruction"
  t2_desc="The building survived World War II bombings largely intact and swiftly resumed operations to serve as an essential public washing and recreational facility."
  t3_year="1970s–1980s"
  t3_title="Community Hub in the GDR"
  t3_desc="Generations of East Berlin school children and citizens utilized the pools and saunas for sports education, physical therapy, and community wellness."
  t4_year="1991"
  t4_title="Permanent Facility Closure"
  t4_desc="Mounting structural deficits, deteriorating pipe infrastructure, and budget shortages following German reunification forced the municipal bathhouse to close its doors."
  t5_year="2000s–Present"
  t5_title="Monument Protection & Cultural Re-use"
  t5_desc="Granted heritage-protected status (*Baudenkmal*), the atmospheric bathhouse now hosts selective exhibitions, film shoots, and organized photo excursions."
>}}
...
If you’re a photographer and love to photograph abandoned places like I do, then the Stadtbad Lichtenberg is definitely worth visiting. Head over to [go2know.de](aff:go2know-das-alte-hubertusbad) to book your tour. Just be quick: As of June 2024, tours are already sold out until August 2024!

If you just want to get a glimpse inside the building, check for events like exhibitions there.

And if you’re already in the Lichtenberg district, you may want to check for a tour at the [Hohenschoenhausen memorial](/blog/abandoned-hohenschoenhausen-prison), a former Stasi prison, that I also visited and blogged about.

For more inspiration, please head to the blog post about other [lost places in Berlin](/blog/must-see-lost-places-berlin) that I have visited recently.
