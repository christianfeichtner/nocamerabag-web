---
title: Inside the abandoned Suedbahnhotel at Semmering
date: '2017-03-27T18:07:57'
page_id: "Dq_6OOPcEK"
slug: abandoned-suedbahn-hotel-semmering
draft: false
...
- Lost Places
- Austria
description: Once a place for the bold and the beautiful. Abandoned 40 years ago,
  this gem now waits for a new owner.
cover:
  image: /images/lost-places/austria/inside-suedbahnhotel-semmering-chimney.webp
  alt: Inside the abandoned Suedbahnhotel at Semmering
---
...
The Suedbahnhotel was built right near the South Railway Track (in German: Suedbahn) that originally connected Vienna, Austria to Triest, Italy. Though Triest is situated in today's Italy, it once belonged to the Austrian Empire until the end of World War I in 1918. (If you're interested in history, here's an [old map of the Austrian Empire](https://en.wikipedia.org/wiki/Austrian_Empire))
...
Though it was abandoned in 1976, the interior is still intact. In fact, the word "abandoned" does not do any justice to this gem. I believe that the term "sleeping" is more accurate. If you have some money in your account, [you can even buy this sleeping beauty](https://suedbahnhotel-semmering.at/?lang=en).
...
Whenever I visit an abandoned sleeping place, I usually do that well prepared and wearing proper clothing. In case you're interested, you can check out and [interview about how I prepare on Mobiography](https://www.mobiography.net/interview/christian-feichtner-interview/). But as the hotel is in exceptionally good condition, that was simply not necessary.

I took all the photos inside using my [AmazonBasics Travel Tripod](/blog/review-amazon-basics-travel-tripod) with the Joby Griptight Mount Pro. I prefer to use the Griptight Pro iPhone tripod mount whenever I need my iPhone mounted to the tripod for sometime like when I explore such places.

Light was quite interesting inside the hotel. Because of the huge windows inside the rooms, I could use natural light and I didn't have to use the ProCamera LowLight modes that I normally use inside dark abandoned places. Instead, I turned to [ProCamera](/blog/procamera-app-review) HDR with the natural preset.

For the "Schrödingers Door" shot, I used [Slow Shutter Cam App](/blog/review-slow-shutter-cam-app).

Back home, I ran each shot through [Adobe Lightroom Mobile](/blog/review-adobe-lightroom-mobile-premium) and uploaded the photos directly from there to Instagram and Flickr.
