---
title: 'Limonitunnel: An abandoned air-raid shelter in Linz, Austria'
date: '2021-03-01T07:43:00'
page_id: "OGU_o51OH_"
slug: abandoned-limonitunnel-linz
draft: false
...
- Austria
- Urbex Tour
description: During a visit to my hometown, I took a tour through an abandoned World
  War II air-raid shelter.
cover:
  image: /images/lost-places/austria/remains-of-the-old-air-flow-system-at-the-limonitunnel.webp
  alt: 'Limonitunnel: An abandoned air-raid shelter in Linz, Austria'
---
...
You can visit the Limonitunnel through guided tours that you can book via the [homepage of the Limonitunnel](https://www.limonistollen.at/english/). The tunnel is located here:

But don't bother going there without a guided tour. The area is under CCTV surveillance.

{{< callout type="info" title="Good to know" >}}
Urbex and guided underground tours change over time. I do not check whether tours are still offered in the same format as when I visited. Please check the organizer's website at the bottom of this page for current tour schedules.
{{< /callout >}}

{{< timeline
  title="Historical Timeline & Key Milestones"
  open="true"
  t1_year="18th–19th Century"
  t1_title="Origins as Beer and Wine Cellars"
  t1_desc="Local breweries and vintners excavated deep sandstone vaults into Linz's Bauernberg hill for cool, year-round storage of perishable goods."
  t2_year="1943"
  t2_title="Air-Raid Bunker Directive"
  t2_desc="As Allied bombers reached Upper Austria from southern Europe, Nazi authorities ordered the subterranean cellars expanded into an interconnected air-raid shelter network."
  t3_year="1944"
  t3_title="Forced Labor Expansion"
  t3_desc="Thousands of forced laborers and concentration camp prisoners from Mauthausen were subjected to brutal labor to hollow out over two miles of underground tunnels."
  t4_year="1945"
  t4_title="Civilian Shelter During Allied Bombings"
  t4_desc="The bunker complex, designated as the Limonistollen, sheltered more than 20,000 citizens during heavy bombardment in the closing stages of the war."
  t5_year="1990s–Present"
  t5_title="Subterranean Preservation & Tours"
  t5_desc="After decades of abandonment and closure, dedicated local historians restored access to educate the public through guided historical tours."
>}}

## Photographing inside the tunnel

Though the tunnel is partially electrified, I found a few spots that weren't, and so I used a technique that I described in a separate blogpost: [how to take photos in total darkness with iPhone](/blog/take-photos-in-darkness).
...
On the one hand, visiting the former air-raid shelter is an interesting experience, but on the other hand also depressing. You'll hear about the forced laborers from Mauthausen that had to work in the tunnels and maybe a few stories about the air raids. If you decide to visit the Limoitunnel, make sure to bring warm clothes. You'll get a flashlight from the guides. But if you want to bring your own, you may want one to have a look at the flashlights that I use for exploring places like these: Read my [Olight S30R review](/blog/review-olight-s30r-iii) or, if you're looking for a smaller flashlight, the [review of the Olight S1R](/blog/review-olight-s1r-baton).

By the way: In the evening on the same day, I photographed a firework. So of you're curious, read the tutorial about [how to photograph fireworks with iPhone](/blog/how-to-photograph-fireworks-with-iphone).
