---
title: 'My Field Notes Pocket Notebook Review for Travel Journaling'
date: '2019-04-15T10:12:00'
page_id: "WxZGe-XgIu"
slug: review-field-notes-notebooks
draft: false
author: Chris Feichtner
categories:
- Traveling Light
featured: true
secondary_title: "Field Notes"
secondary_description: "Durable, pocket-sized memo books for travel journaling and quick thoughts on the go."
affiliate_id: "affiliates://field-notes-memo-books"
affiliate_label: "Buy on Amazon"
tags:
- Travel Accessories
- Review
description: Field Notes Notebooks are a perfect analogue travel companion. Here's
  a review and how I use them for traveling.
cover:
  image: /images/reviews/usa/review-field-notes-memo-books-travel.webp
  alt: 'Review: Field Notes Notebooks and use for traveling'
---
...
However, back in 2012, roughly at the same time, I ditched my DSLR for iPhone photography, I also slimmed down my wallet and began to focus on [traveling light](/traveling-light).
...
That's when I discovered Field Notes Notebooks. They seemed just right for me, and so I ordered my first 3-pack of the [Pitch Black Field Notes Memo Books](aff:pitch-black-field-notes-memo) from Amazon.
...
I've ordered my first [Field Notes Memo Book from Amazon](aff:field-notes-memo-books) and ordered a new pack of 3 whenever I ran out. Don't forget to select the size (Small Memo Book or larger Note Book and if you want a dot graph or ruled paper).

As I began to use Field Notes Memo Books for other things like personal journaling (not travel related), for special projects (like my genealogical research) and more, I got myself a [Filed Notes quarterly subscription](https://fieldnotesbrand.com/#products).

SoI get a new and uniquely designed three-pack delivered to my doorstep every three months.

Usually, you can get the current and [limited editions of Field Notes Memo Books from Amazon](aff:field-notes-memo-books), too.

## Recommended Accessories for Field Notes Notebooks
...
You can check the reviews and get a [Bellroy Field Notes Cover from Amazon](aff:bellroy-field-notes-cover).
...
You may want to read my [Fisher Space Pen Bullet review](/blog/fisher-space-pen-bullet-review) or check the prices and reviews of the [Bullet Space Pen on Amazon](affiliates://fisher-space-pen-bullet).
