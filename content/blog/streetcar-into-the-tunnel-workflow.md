---
title: 'iPhone Workflow Tutorial: "Streetcar into the Tunnel"'
date: '2020-02-24T19:24:00'
page_id: "wg8G_57t8K"
slug: streetcar-into-the-tunnel-workflow
draft: false
...
- Tutorials
- Workflow
description: Another iPhone workflow tutorial showing how I shot and edited this photo
  with iPhone.
cover:
  image: /images/cityscapes/slovakia/long-exposure-of-a-tram-entering-the-tunnel.webp
  alt: 'iPhone Workflow Tutorial: "Streetcar into the Tunnel"'
---
...
I already knew the location. I've been there a few years ago and took a photo of the empty tunnel using [ProCamera App](/blog/procamera-app-review).

There are two major problems at this location. First, the area is tiny. The even smaller area to the left and right of the rails is steep, and there are buildings to the left and right. So, no room here to safely put up a tripod.
...
As I could not use my new [Rollei Compact Traveller No. 1 Carbon](/blog/review-rollei-compact-traveller-no-1-carbon-tripod) tripod here, I decided trying to take a handheld Live Photo and to [convert the Live Photo into a Long Exposure](/blog/live-photo-to-long-exposure).
...
I added the final touches in [Adobe Lightroom Mobile](/blog/review-adobe-lightroom-mobile-premium) by increasing the contrast to 60 to add a bit of a dramatic look and to further darken the inside of the tunnel. I also reduced the whites to -30 reduced the blacks to -40 even further to dramatise the look and make the inside of the tube darker.
