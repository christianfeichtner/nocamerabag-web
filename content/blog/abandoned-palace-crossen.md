---
title: Photos from my urbex tour at the abandoned palace Crossen
date: '2025-07-29T15:36:18'
page_id: "yl4QGpL2KV"
slug: abandoned-palace-crossen
draft: false
...
- Germany
- Urbex Tour
secondary_title: "Crossen Palace: Inside the Decaying Baroque Ballroom"
secondary_description: "Step into an 18th-century masterpiece of trompe-l'œil murals, crumbling stucco, and historic silence."
affiliate_id: "affiliates://crossen_tour"
description: The Palace of Crossen served as an educational institution before it
  was abandoned in 1991. See some photos of my urbex tour to this palace in Germany.
cover:
  image: 
  alt: Photos from my urbex tour at the abandoned palace Crossen
---
...
## Know before you go to the Palace of Crossen
...
{{< timeline
  ...
  open="true"
  t1_year="10th Century"
  t1_title="Origins as a Medieval Stronghold"
  t1_desc="The site began as a fortified complex strategically positioned on a hilltop overlooking the White Elster river valley."
  t2_year="1712"
  t2_title="Baroque Palace Transformation"
  t2_desc="Under the von Flemming family, the estate was rebuilt into a grand Baroque residence, complete with the breathtaking ballroom decorated with Italian illusionistic frescoes."
  t3_year="1925–1945"
  t3_title="Interim Uses & World War II"
  t3_desc="After changing private owners in the 1920s, the palace served various interim purposes and was used as military quarters during World War II."
  t4_year="1953"
  t4_title="GDR Teacher Training College"
  t4_desc="The East German government converted the building into an educational college (*Institut für Lehrerbildung*), adapting the historic chambers into classrooms and student dormitories."
  t5_year="1991"
  t5_title="Closure & Heritage Preservation"
  t5_desc="Following German reunification, operations ceased and the palace sat vacant. Today, a dedicated non-profit association actively preserves the historical estate and facilitates guided access."
>}}
...
Urbex tour availability and itineraries change regularly. I do not actively verify if the tours are still offered the way I experienced them. Please check the operator's website linked at the bottom of this post for current details.
{{< /callout >}}
...
Generally, it’s a good idea to follow the safety rules I’ve outlined in my [urbex rules](/urbex-tours) guide.
...
To book your tour, head over to the go2know website and book your [tour for the abandoned baroque palace](aff:go2know-barockschloss-elster) (please note, that the website is in German).

Throughout the years, I've visited a number of lost places like this. For more such places, please check my [list of urbex tours](/urbex-tours) I've attended.
