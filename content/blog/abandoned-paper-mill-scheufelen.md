---
title: Exploring the abandoned paper mill Scheufelen, Germany
date: '2023-07-18T18:19:45'
page_id: "rFk3n9-4Z_"
slug: abandoned-paper-mill-scheufelen
draft: false
...
- Germany
- Urbex Tour
description: This abandoned paper mill is a lost place unlike any other I’ve visited
  before. The factory was abandoned just a few years ago during the pandemic.
affiliate_id: "affiliates://go2know-papierfabrik-scheufelen"
cover:
  image: 
  alt: Exploring the abandoned paper mill Scheufelen, Germany
---
...
The abandoned paper factory is fenced in and guarded. But the easiest way to get in is to book one of the photo tours at [go2know.de](aff:go2know-papierfabrik-scheufelen). It's worth it. The area is enormous, and you'll see abandoned control rooms, offices, and the vast buildings that formerly contained the paper machines.

{{< callout type="info" title="Please note" >}}
Urban exploration tours and access permissions change frequently. I do not keep track of whether tours are still available as they were when I visited. Please consult the tour organizer's website at the bottom of the page for current info.
{{< /callout >}}
...
{{< timeline
  ...
  open="true"
  t1_year="1769"
  t1_title="Founding of the Lenningen Paper Mill"
  t1_desc="Paper manufacturing began along the Lauter river in Oberlenningen as a traditional water-driven manual paper mill."
  t2_year="1855"
  t2_title="Acquisition by Karl Scheufelen"
  t2_desc="Karl Scheufelen took over the mill, driving mechanization and laying the foundation for an industrial paper manufacturing powerhouse."
  t3_year="1892"
  t3_title="Pioneering Art Coated Paper"
  t3_desc="The factory patented Europe's first modern double-sided coated printing paper (*Kunstdruckpapier*), gaining international prestige for ultra-high-grade graphic paper."
  t4_year="2008"
  t4_title="Insolvency Amid Market Shifts"
  t4_desc="Surging energy costs and global competition severely hit operations, pushing the historic family enterprise into insolvency and ownership restructuring."
  t5_year="2019"
  t5_title="Permanent Plant Shutdown"
  t5_desc="Despite pioneering sustainable grass-based paper innovations, production ceased entirely in 2019, turning the sprawling industrial site into an evocative lost place."
>}}
