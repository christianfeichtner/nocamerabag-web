---
title: 10 urbex rules to ensure a safe experience when exploring a lost place
date: '2025-07-22T19:15:36'
page_id: "d2XDJ5OFPy"
slug: urbex-rules
draft: false
...
- Lost Places
- Urban Exploration
description: Urban exploration is an exciting and rewarding hobby. To stay safe, I’ve
  compiled a list of my self-imposed urbex rules in this blog post.
cover:
  image: /images/lost-places/general/urbex-rules-teaser.webp
  alt: 10 urbex rules to ensure a safe experience when exploring a lost place
---
...
To avoid legal issues, I recommend attending a legal urban exploration tour like the ones I list on my overview page of [urbex tours](/urbex-tours).
...
* At least two fully charged flashlights. One of them should be able to emit at least 5.000 to 7.000 lumens continuously. I use the Wuben X1 as my primary flashlight for exploring lost places. It has multiple brightness levels and a turbo mode that creates a 12.000 lumen beam. You can read more about it in my [Wuben X1 review](/blog/review-wuben-x1-falcon-flashlight). The second flashlight is a smaller one from Olight that I use as a backup when my Wuben X1 runs out of power.
...
* Two fully charged powerbanks. I use two different Anker MagSafe models. You can read about them in my [Anker MagSafe powerbanks review](/blog/review-anker-powercore-magnetic-5k).
* A first aid kit that allows you to treat small wounds like scratches, etc. Hiking first aid kits are ideal for that.
* A tripod or a monopod for taking pictures in bad light conditions. For taking photos in total darkness, you may want to check my tutorial about [how to take photos in darkness with iPhone](/blog/take-photos-in-darkness).
...
If you plan a trip to Berlin, be sure to check out my list of [lost places in Berlin](/blog/must-see-lost-places-berlin) you can visit legally. If you’re going to New York, I recommend booking a [hard hat tour at the abandoned immigration hospital on Ellis Island](/blog/abandoned-immigration-hospital-ellis-island). And if you’re planning to come to Vienna, you may find the [abandoned cellar tours in Vienna](/blog/abandoned-vienna-underground-tunnel) and the former [World War II bunker tour in Vienna](/blog/vienna-underground-tour-jerryously) interesting.
