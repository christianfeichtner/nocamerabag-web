---
title: 'What''s new in iOS 10 for photographers: Camera App and Photos App'
date: '2016-07-12T21:01:42'
page_id: "H4EQxyWHjv"
slug: whats-new-ios10
draft: false
...
- Camera Apps
- Photo Editing Apps
description: Finally iOS10 is out and everyone can enjoy the exciting new functions
  in the Photos App. Check out my post to see what's new in iOS10 Photos App.
cover:
  image: /images/iphone-photography/general/ios10-logo.webp
  alt: 'What''s new in iOS 10 for photographers: Camera App and Photos App'
---
Finally iOS10 is out and everyone can enjoy the new functionality in the iOS10 photos app. I used iOS10 since the first public beta and could gather some experience with it in the past months. The photos app in ios10 has some nice additions for iPhone photographers.

So, here's what's new in iOS10 Photos App.

## iOS 10 Photos App first look

On first look, the iOS 10 photos app has not changed much. The only visible difference is the "Memories" icon in the toolbar. I'll talk about that in a minute or two.

The "photos" icon works pretty much the same as in previous iOS versions with one exception. Tapping on a location in "collection view" will take you to a memories screen. There you can create a video slideshow of photos from that particular location.
...
This is one of the notable new function of the iOS 10 photos app. You can now create videos of your favourite shots and videos. The iPhone choses photos that it thinks belong together and creates a slideshow from them. You can add and remove photos as well as chose from different kinds of background music and adjust the length of the slideshow.
...
The shared screen is pretty like it was in iOS 9. It shows all your shared iCloud photo streams and the ones that are shared with you. From here you can browse the photo streams, like or comment on photos and even add photos to a stream.
...
After that you can add a name to the face iOS10 has discovered.

Also new is the dedicated "places" album. Tapping it will display a world map with all your photos on it (given you've enabled geotagging for your photos). The photos are stacked by location and as soon as you zoom in the stacks are split and photos are. Positioned more accurately. Tap on a stack to see all the photos from that location.

![](/images/iphone-photography/general/whats-new-ios10.webp)

## Search in iOS10 photos app
...
This is a huge timesaver! From now on I can skip assigning keywords to photos because the iPhone recognises most of them. However, I didn't find a way yet to tell the photos app that it identified a photo wrong. For example, it detected a photo with a west highland white terrier as "food".

Did you find additional keywords that work? Tell the world in the comments below.

## New Brilliance Adjustment Slider
