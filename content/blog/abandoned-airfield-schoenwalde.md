---
title: Photos of the Abandoned Airfield Schönwalde
date: '2024-07-14T15:28:16'
page_id: "-2SC1smq3k"
slug: abandoned-airfield-schoenwalde
draft: false
...
- Germany
- Urbex Tour
description: I had a chance to visit the abandoned airfield Schönwalde. In this blog
  post, you’ll see photos of my visit and learn, how you can see this lost place.
affiliate_id: "affiliates://go2know-fliegerhorst-schoenwalde"
cover:
  image: 
  alt: Photos of the Abandoned Airfield Schönwalde
---
...
As always, I visited this lost place by booking a tour with my favorite operator, [go2know.de](aff:go2know-fliegerhorst-schoenwalde) (whose Website is in German).
...
Urbex tours and access conditions change regularly. I do not monitor whether tours are still offered in the same format as when I visited. Please check the tour operator’s website linked at the end of this page for the latest updates.
{{< /callout >}}
...
{{< timeline
  ...
  open="true"
  t1_year="1935"
  t1_title="Luftwaffe Flight Training Airfield"
  t1_desc="The airfield was constructed and opened under strict secrecy as a major training base and flight school for the German Luftwaffe."
  t2_year="1943"
  t2_title="World War II Supply Hub"
  t2_desc="As the war intensified, the facility transitioned into a crucial logistical air base handling military transport and supply flights."
  t3_year="1945"
  t3_title="Soviet Red Army Occupation"
  t3_desc="Soviet forces captured the airfield during the Battle of Berlin, establishing a permanent military garrison that expanded into a self-contained garrison town."
  t4_year="1965"
  t4_title="Transition to Armored Regiment Base"
  t4_desc="Because the grass runway could not accommodate modern jet aircraft, fixed-wing flight operations ceased and the complex was converted into a tank and armored vehicle base."
  t5_year="1992"
  t5_title="Final Military Withdrawal & Abandonment"
  t5_desc="Following German reunification and the collapse of the Soviet Union, Russian troops completely vacated the site, leaving dozens of buildings to nature's reclamation."
>}}
...
If you are eager to explore one of the largest lost places around Berlin, then you should definitely consider booking a photo tour with [go2know and visiting the abandoned airfield Schönewalde](aff:go2know-fliegerhorst-schoenwalde). But you better hurry. As far as I’ve heard, the owner plans to level this lost place and build apartment buildings. Work should start at the end of 2024.

This is just one of the many [lost places in Berlin](/blog/must-see-lost-places-berlin) that I have visited in recent years.
