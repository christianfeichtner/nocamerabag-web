---
title: Impressions from an abandoned WWII Tunnel in Vienna
date: '2024-04-04T17:54:30'
page_id: "l7qd8_r80B"
slug: vienna-underground-tour-jerryously
draft: false
...
- Austria
- Urbex Tour
description: In January I was out and about in Vienna’s underground again - sometimes
  on all fours. See a curated selection of photos of what I could see down there.
cover:
  image: /images/lost-places/austria/vienna-underaground-jerrously-teaser.webp
  alt: Impressions from an abandoned WWII Tunnel in Vienna
---
...
Urbex tours and access conditions change regularly. I don't continuously check whether tours are still operated exactly as when I attended. Please visit the guide’s website at the bottom of this post for the latest tour information.
{{< /callout >}}

{{< timeline
  title="Historical Timeline & Key Milestones"
  open="true"
  t1_year="18th Century (1744)"
  t1_title="Construction of Deep Inner-City Cellars"
  t1_desc="Multi-story subterranean vaults were excavated beneath Vienna's first district to store perishable wine, beer, and winter ice blocks."
  t2_year="1890s"
  t2_title="Underground Infrastructure Expansion"
  t2_desc="Extensive subterranean canal networks and river regulation projects dramatically reshaped and deepened Vienna's hidden underground topology."
  t3_year="1940–1944"
  t3_title="Wartime Air-Raid Bunker Conversion"
  t3_desc="Civil defense authorities interconnected private deep cellars with breakthrough tunnels (*Luftschutz-Stollen*) to create subterranean bomb shelters."
  t4_year="1945"
  t4_title="Lifeline During the Battle of Vienna"
  t4_desc="The underground tunnel web provided vital refuge for tens of thousands of Viennese civilians during Allied aerial bombings and fierce urban combat."
  t5_year="2010s–Present"
  t5_title="Historical Rediscovery & Guided Expeditions"
  t5_desc="Urban explorers and historians like Jerryously gained permission to research, document, and safely guide curious visitors through these hidden subterranean worlds."
>}}
...
During this tour, I used my Wuben X1 flashlight that emits a whooping 12.000 lumens. As you can see from the pictures, that is enough to brighten an entire room, which would otherwise be total dark. To learn why I bought this tactical flashlight, head to my [Wuben X1 review](/blog/review-wuben-x1-falcon-flashlight).
